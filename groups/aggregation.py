...
def aggregate(indices):
    ...
    return list_nums_AVG, list_ratings_AVG, list_nums_LM, list_ratings_LM
...
for i in range(num_samples):
    ...
    list_nums_AVG, list_ratings_AVG, list_nums_LM, list_ratings_LM = aggregate(indices)
